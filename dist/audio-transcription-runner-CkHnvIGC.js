import { B as resolvePreferredOpenClawTmpDir, w as shouldLogVerbose, x as logVerbose } from "./subsystem-kzdGVyce.js";
import { Hr as requireApiKey, Lr as normalizeGoogleModelId, Tr as normalizeProviderId, Ur as resolveApiKeyForProvider, at as resolveIMessageAttachmentRoots, it as mergeInboundPathRoots, nt as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, rt as isInboundPathAllowed } from "./auth-profiles-UpqQjKB-.js";
import { N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue } from "./agent-scope-BDXYqF89.js";
import { n as runExec } from "./exec-CDUUaRm4.js";
import { k as normalizeChatType } from "./plugins-v0UiRqAc.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-BZX4S9OA.js";
import { i as formatUncaughtError, n as extractErrorCode, s as readErrorName, t as collectErrorGraphCandidates } from "./errors-oTqWODa8.js";
import { n as loadModelCatalog, r as modelSupportsVision, t as findModelInCatalog } from "./model-catalog-RhG2KE3w.js";
import { a as getDefaultMediaLocalRoots, n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-CEXnYKAv.js";
import { n as fetchWithTimeout } from "./fetch-timeout-CRMsbSxL.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-W2TcXMQH.js";
import { t as describeImageWithModel } from "./image-CiVJHtoW.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BQqyYKRt.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-BJuVlAGN.js";
...
//#endregion
export { installUnhandledRejectionHandler as _, resolveAutoImageModel as a, resolveAttachmentKind as b, applyTemplate as c, normalizeMediaUnderstandingChatType as d, resolveMediaUnderstandingScope as f, buildRandomTempFilePath as g, DEFAULT_IMAGE_MODELS as h, normalizeMediaAttachments as i, resolveConcurrency as l, CLI_OUTPUT_MAX_BUFFER as m, buildProviderRegistry as n, resolveMediaAttachmentLocalRoots as o, AUTO_IMAGE_KEY_PROVIDERS as p, createMediaAttachmentCache as r, runCapability as s, runAudioTranscription as t, resolveTimeoutMs as u, registerUnhandledRejectionHandler as v, isAudioAttachment as y };
