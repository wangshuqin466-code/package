...
import { c as normalizeBrowserFormField, i as resolveExistingPathsWithinRoot, n as DEFAULT_TRACE_DIR, o as resolveWritablePathWithinRoot, r as DEFAULT_UPLOAD_DIR, t as DEFAULT_DOWNLOAD_DIR } from "./paths-Bv0Fd5hm.js";
import { n as SsrFBlockedError } from "./proxy-env-DBXIh4R2.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-oTqWODa8.js";
import { a as saveMediaBuffer, r as ensureMediaDir } from "./store-Cpd6HHUc.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DQeJu-FG.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-DQeJu-FG.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
