import { u as resolveGatewayPort } from "./paths-BJV7vkaX.js";
import { dn as writeConfigFile, en as createConfigIO, rn as loadConfig } from "./model-selection-Dovilo6b.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-ZqKzSyNC.js";
import { t as parseBooleanValue } from "./boolean-CJxfhBkG.js";
import { A as BrowserResourceExhaustedError, B as withBrowserNavigationPolicy, C as resolveCdpReachabilityTimeouts, D as BrowserProfileNotFoundError, E as BrowserConflictError, F as InvalidBrowserNavigationUrlError, G as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, H as DEFAULT_AI_SNAPSHOT_MAX_CHARS, I as assertBrowserNavigationAllowed, M as BrowserTargetAmbiguousError, N as BrowserValidationError, O as BrowserProfileUnavailableError, P as toBrowserErrorResponse, R as assertBrowserNavigationResultAllowed, T as BrowserConfigurationError, V as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, W as DEFAULT_OPENCLAW_BROWSER_COLOR, _ as normalizeCdpHttpBaseForJsonEndpoints, a as resolveOpenClawUserDataDir, b as stopChromeExtensionRelayServer, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, h as fetchOk, i as launchOpenClawChrome, j as BrowserTabNotFoundError, k as BrowserResetUnsupportedError, l as createTargetViaCdp, m as fetchJson, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, x as CDP_JSON_NEW_TIMEOUT_MS, y as ensureChromeExtensionRelayServer, z as requiresInspectableBrowserNavigationRedirects } from "./chrome-zmDkfOk2.js";
import { i as isLoopbackHost } from "./ws-BSKgXzsx.js";
import { a as resolveGatewayAuth } from "./auth-CZOQIbmN.js";
import { n as hasGatewayPasswordEnvCandidate, o as readGatewayTokenEnv, r as hasGatewayTokenEnvCandidate } from "./credentials-BhjOnp5p.js";
import { t as assertExplicitGatewayAuthModeWhenBothConfigured } from "./auth-mode-policy-2pLi0rPx.js";
import { r as resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string-D-y9gugr.js";
import { c as normalizeBrowserFormField, i as resolveExistingPathsWithinRoot, n as DEFAULT_TRACE_DIR, o as resolveWritablePathWithinRoot, r as DEFAULT_UPLOAD_DIR, t as DEFAULT_DOWNLOAD_DIR } from "./paths-D3yvzAGG.js";
import { n as SsrFBlockedError } from "./proxy-env-DWmS7QpH.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-BOqrY9lx.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-C7PfPJb_.js";
import { a as saveMediaBuffer, r as ensureMediaDir } from "./store-CF7lpR6V.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CY8ct-oB.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-CY8ct-oB.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
