...
import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-4K-e3L3i.js";
...
import { s as isValidEnvSecretRefId } from "./types.secrets-ZqKzSyNC.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-qnb8BYWo.js";
...
import "./daemon-runtime-BSeNz-AR.js";
import { t as runOnboardingWizard } from "./onboarding-DdTtYcWy.js";
import { n as logConfigUpdated } from "./logging-YCHxe4L1.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-stViiK6W.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-DVz8vqpA.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DxhkjhiH.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-CC4TR_ih.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-CwgmZsQL.js").then((n) => n.i);
