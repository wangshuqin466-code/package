...
import { D as colorize, O as isRich$1, f as defaultRuntime, k as theme } from "./subsystem-4K-e3L3i.js";
import { S as shortenHomePath } from "./utils-BhZbo8Nw.js";
import "./thinking-BYwvlJ3S.js";
import { Br as resolveModelWithRegistry, Cn as describeFailoverError, Ct as runEmbeddedPiAgent, Gt as resolveUsageProviderId, Ht as loadProviderUsageSummary, Wt as formatUsageWindowSummary, a as buildAuthHealthSummary, i as DEFAULT_OAUTH_WARN_MS, o as formatRemainingShort, r as maskApiKey } from "./reply-DeXK9BLT.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-CZF6h_5g.js";
...
import { A as resolveAwsSdkEnvVarName, Ai as resolveAuthStorePathForDisplay, D as getCustomProviderApiKey, Ii as resolveAuthProfileDisplayLabel, Pt as resolveSecretRefString, Ui as DEFAULT_MODEL, Wi as DEFAULT_PROVIDER, _t as resolveAuthProfileEligibility, bi as setAuthProfileOrder, c as modelKey, d as normalizeProviderId, en as createConfigIO, f as parseModelRef, g as resolveDefaultModelForAgent, h as resolveConfiguredModelRef, i as findNormalizedProviderValue, it as isNonSecretApiKeyMarker, j as resolveEnvApiKey, ji as resolveOpenClawAgentDir, k as resolveApiKeyForProvider, kn as parseDurationMs, ln as setRuntimeConfigSnapshot, pi as shouldEnableShellEnvFallback, r as buildModelAliasIndex, rn as loadConfig, sn as readConfigFileSnapshotForWrite, ui as getShellEnvAppliedKeys, v as resolveModelRefFromString, vi as listProfilesForProvider, vt as resolveAuthProfileOrder, wi as ensureAuthProfileStore, wt as resolveProfileUnusableUntilForDisplay, xi as upsertAuthProfile } from "./model-selection-Dovilo6b.js";
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-ZqKzSyNC.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-BXRmsWer.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-7ljJh5Io.js";
import "./connection-auth-Ikf5YLLJ.js";
import { f as openUrl } from "./onboard-helpers-qnb8BYWo.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-B5O9_EBZ.js";
import "./help-format-BWGBPI0G.js";
import { r as withProgressTotals } from "./progress-B8wjC50f.js";
import "./note-Cew4NgiY.js";
import { t as createClackPrompter } from "./clack-prompter-8Yz_I3SK.js";
import "./issue-format-BLSisWPS.js";
import { t as renderTable } from "./table-BB7dDBqh.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BaUZWd0c.js";
import { n as redactSecrets } from "./format-D_kN2IE2.js";
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-DgjgwUHF.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-B-NaKHZM.js";
import { n as logConfigUpdated } from "./logging-YCHxe4L1.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, l as githubCopilotLoginCommand, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-C36Cj-cf.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-Dovilo6b.js").then((n) => n.gt);
	const { ensureOpenClawModelsJson } = await import("./models-config-CC0tOC2Q.js").then((n) => n.n);
