import { c as resolveStateDir, d as resolveRequiredHomeDir, l as expandHomePrefix, o as resolveOAuthDir } from "./paths-DkxwiA8g.js";
import { d as logVerbose, l as danger, t as createSubsystemLogger } from "./subsystem-C9Gk4AAH.js";
import { K as normalizeAccountId } from "./workspace-Cn3fdLBW.js";
import { a as CONFIG_DIR, b as safeParseJson } from "./logger-CJbXRTpA.js";
import { $ as loadConfig, Xn as resolveTelegramPreviewStreamMode, ar as isTruthyEnvValue, it as writeConfigFile, pr as withFileLock$1, tt as readConfigFileSnapshotForWrite } from "./model-selection-C8ExQCsd.js";
import { c as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-GLBgHzdU.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-BeLmzYBi.js";
import { D as normalizeMimeType, E as kindFromMime, S as getFileExtension, T as isGifMedia } from "./image-ops-BnQjE9aK.js";
import { t as hasProxyEnvConfigured } from "./proxy-env-C2KrBwJo.js";
import { t as redactSensitiveText } from "./redact-BHkqR4gQ.js";
import { i as formatUncaughtError, n as extractErrorCode, o as readErrorName, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-CH6uzT9l.js";
import { r as writeJsonAtomic } from "./json-files-2lGNRIr-.js";
import { t as makeProxyFetch } from "./proxy-fetch-53_Tkfsi.js";
import { a as loadWebMedia, n as markdownToIR, s as resolveMarkdownTableMode, t as chunkMarkdownIR } from "./ir-BXNEFjR6.js";
import { t as renderMarkdownWithMarkers } from "./render-7C7EDC8_.js";
import { t as resolveFetch } from "./fetch-CONQGbzL.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-8E8d5aiU.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-zcU_HRA_.js";
import { n as normalizePollInput } from "./polls-DQBoGben.js";
...
//#endregion
export { readChannelAllowFromStore as $, expandTextLinks as A, resolveTelegramStreamMode as B, buildSenderName as C, buildTelegramThreadParams as D, buildTelegramParentPeer as E, resolveTelegramDirectPeerId as F, resolveSenderAllowMatch as G, isSenderAllowed as H, resolveTelegramForumThreadId as I, mergeDmAllowFromSources as J, firstDefined as K, resolveTelegramGroupAllowFromContext as L, getTelegramTextParts as M, hasBotMention as N, buildTypingThreadParams as O, normalizeForwardedContext as P, addChannelAllowFromStoreEntry as Q, resolveTelegramMediaPlaceholder as R, buildSenderLabel as S, buildTelegramGroupPeerId as T, normalizeAllowFrom as U, resolveTelegramThreadSpec as V, normalizeDmAllowFromWithStore as W, formatLocationText as X, resolveGroupAllowFromSources as Y, toLocationContext as Z, splitTelegramCaption as _, reactMessageTelegram as a, listPairingChannels as at, resolveCronStorePath as b, sendStickerTelegram as c, isRecoverableTelegramNetworkError as d, removeChannelAllowFromStoreEntry as et, markdownToTelegramChunks as f, resolveTelegramFetch as g, wrapFileReferencesInHtml as h, editMessageTelegram as i, getPairingAdapter as it, extractTelegramLocation as j, describeReplyTarget as k, resolveTelegramVoiceSend as l, renderTelegramHtmlText as m, createForumTopicTelegram as n, readJsonFileWithFallback as nt, sendMessageTelegram as o, isVoiceCompatibleAudio as ot, markdownToTelegramHtml as p, isSenderIdAllowed as q, deleteMessageTelegram as r, writeJsonFileAtomically as rt, sendPollTelegram as s, buildInlineKeyboard as t, upsertChannelPairingRequest as tt, wasSentByBot as u, withTelegramApiErrorLogging as v, buildTelegramGroupFrom as w, buildGroupLabel as x, loadCronStore as y, resolveTelegramReplyId as z };
