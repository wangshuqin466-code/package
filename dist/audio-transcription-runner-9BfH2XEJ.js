import { B as resolvePreferredOpenClawTmpDir, w as shouldLogVerbose, x as logVerbose } from "./subsystem-4K-e3L3i.js";
import { N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue } from "./agent-scope-CZF6h_5g.js";
import { n as runExec } from "./exec-WYU5B_af.js";
import { C as normalizeGoogleModelId, O as requireApiKey, _n as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, bn as resolveIMessageAttachmentRoots, d as normalizeProviderId, k as resolveApiKeyForProvider, vn as isInboundPathAllowed, yn as mergeInboundPathRoots } from "./model-selection-Dovilo6b.js";
import { I as normalizeChatType } from "./plugins-B4oqCXNl.js";
import { t as describeImageWithModel } from "./image-CVfYjry_.js";
import { i as formatUncaughtError, n as extractErrorCode, s as readErrorName, t as collectErrorGraphCandidates } from "./errors-BOqrY9lx.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-C7PfPJb_.js";
import { n as fetchWithTimeout } from "./fetch-timeout-8khMZ6hI.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CEIL7OSV.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-wzo3w_dE.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-B7FLdvEW.js";
import { n as loadModelCatalog, r as modelSupportsVision, t as findModelInCatalog } from "./model-catalog-Dg5d3V3D.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-B79ly90H.js";
...
//#endregion
export { AUTO_IMAGE_KEY_PROVIDERS as _, resolveAutoImageModel as a, applyTemplate as b, buildRandomTempFilePath as c, isAudioAttachment as d, resolveAttachmentKind as f, resolveMediaUnderstandingScope as g, normalizeMediaUnderstandingChatType as h, normalizeMediaAttachments as i, installUnhandledRejectionHandler as l, resolveTimeoutMs as m, buildProviderRegistry as n, resolveMediaAttachmentLocalRoots as o, resolveConcurrency as p, createMediaAttachmentCache as r, runCapability as s, runAudioTranscription as t, registerUnhandledRejectionHandler as u, CLI_OUTPUT_MAX_BUFFER as v, DEFAULT_IMAGE_MODELS as y };
