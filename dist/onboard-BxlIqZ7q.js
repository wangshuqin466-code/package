import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-kzdGVyce.js";
...
import { s as isValidEnvSecretRefId } from "./types.secrets-CQ90JO4F.js";
import { i as resolveDefaultSecretProviderAlias } from "./ref-contract-jOY49gqa.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-Be9c-Ktq.js";
import { t as WizardCancelledError } from "./prompts-s5Kzq1GQ.js";
import { t as createClackPrompter } from "./clack-prompter-G-XGtgN3.js";
import { t as assertSupportedRuntime } from "./runtime-guard-qGANlyDE.js";
import "./daemon-runtime-D9VSfwQu.js";
import { t as runOnboardingWizard } from "./onboarding-Biq7B2y0.js";
import { n as logConfigUpdated } from "./logging-BvRxc8kO.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-BnliJ75t.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-w5ixBK6w.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-CRxQ8tMT.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-cJzEgj2F.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-DL8GZdZB.js").then((n) => n.i);
