import { M as getResolvedLoggerSettings, f as defaultRuntime } from "./subsystem-kzdGVyce.js";
import { d as resolveIsNixMode, g as resolveStateDir, m as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort, y as resolveRequiredHomeDir } from "./paths-BfR2LXbA.js";
import { r as isTruthyEnvValue$1 } from "./entry.js";
import { G as readConfigFileSnapshot, Hi as CODEX_CLI_PROFILE_ID, Ri as DEFAULT_MODEL, Ur as resolveApiKeyForProvider, Vi as CLAUDE_CLI_PROFILE_ID, X as writeConfigFile, Yn as repairOAuthProfileIdMismatch, d as resolveApiKeyForProfile, jr as resolveHooksGmailModel, kr as resolveConfiguredModelRef, l as resolveProfileUnusableUntilForDisplay, rr as ensureAuthProfileStore, sr as updateAuthProfileStoreWithLock, yr as getModelRefStatus, zi as DEFAULT_PROVIDER } from "./auth-profiles-UpqQjKB-.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-BDXYqF89.js";
import { E as parseAgentSessionKey } from "./session-key-GuEQvqMH.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-B4wShrgI.js";
...
import { Bt as DEFAULT_OAUTH_WARN_MS, Ht as formatRemainingShort, Vt as buildAuthHealthSummary, br as resolveBootstrapContextForRun, c as loadOpenClawPlugins, lr as analyzeBootstrapBudget, mr as resolveAgentSessionDirs, ur as buildBootstrapInjectionStats } from "./compact-D3emcZgv.js";
import { n as listChannelPlugins } from "./plugins-v0UiRqAc.js";
import { B as resolveBootstrapTotalMaxChars, R as resolveBootstrapMaxChars } from "./pi-embedded-helpers-nnm4iOi3.js";
import { E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-D5S9pIUQ.js";
import { d as resolveGatewayBindHost, i as isLoopbackHost } from "./ws-BzHIlqUk.js";
import { a as resolveGatewayAuth } from "./auth-ztX1XT7i.js";
import { o as readGatewayTokenEnv } from "./credentials-UUOBfSK0.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-Cu8MtMRs.js";
import { n as resolveConfiguredSecretInputWithFallback } from "./resolve-configured-secret-input-string-CALUVGLW.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-DwmubRiU.js";
import { c as loadSessionStore, lt as cleanStaleLockFiles, tt as resolveMainSessionKey } from "./sessions-Bh025Q5O.js";
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-B2sAT1mc.js";
import { c as resolveStorePath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-D3cXuvcv.js";
import { n as loadModelCatalog } from "./model-catalog-RhG2KE3w.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BfhGytph.js";
import { l as resolveDmAllowState } from "./pi-tools.policy-B0vneueD.js";
import { g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./arg-split--6QZMCyf.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-Dz64QC9N.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-Be9c-Ktq.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DMLxb9pN.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-C0jP3BCc.js";
import { i as resolveMemorySearchConfig, r as hasConfiguredMemorySecretInput } from "./manager-_AfSnopa.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BMEa9FVA.js";
import { t as note$1 } from "./note-D7vkWKMM.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CpfvpmtK.js";
import { a as renderSystemNodeWarning, o as resolveSystemNodeInfo } from "./daemon-install-plan.shared-D5f-djeh.js";
...
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-D9VSfwQu.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-CKDkXL0B.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, t as resolveGatewayService } from "./service-CdVcSUMi.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-DL7pm3Qo.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-CAedsq6U.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-B8EFjiGh.js";
import { r as healthCommand } from "./health-DL8GZdZB.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DCpYiequ.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-D8x6Enw3.js";
import { t as runGatewayUpdate } from "./update-runner-CGkDyVpo.js";
import { n as logConfigUpdated } from "./logging-BvRxc8kO.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-Bfx_Ub6N.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-CMTKVVjq.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B3024S1v.js";
import { t as formatHealthCheckFailure } from "./health-format-BNuFmMPb.js";
import { n as doctorShellCompletion } from "./doctor-completion-O9nKgL7e.js";
