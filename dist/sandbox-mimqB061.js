import { r as STATE_DIR } from "./paths-BJV7vkaX.js";
import { f as defaultRuntime, t as createSubsystemLogger } from "./subsystem-4K-e3L3i.js";
import { y as resolveUserPath } from "./utils-BhZbo8Nw.js";
import { D as ensureAgentWorkspace, E as DEFAULT_USER_FILENAME, T as DEFAULT_TOOLS_FILENAME, _ as DEFAULT_AGENTS_FILENAME, b as DEFAULT_HEARTBEAT_FILENAME, h as resolveSessionAgentId, i as resolveAgentConfig, v as DEFAULT_AGENT_WORKSPACE_DIR, w as DEFAULT_SOUL_FILENAME, x as DEFAULT_IDENTITY_FILENAME, y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-CZF6h_5g.js";
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-BFl8Ucce.js";
import { i as openBoundaryFile, u as resolvePathViaExistingAncestorSync } from "./openclaw-root-DrFjwUcG.js";
import { En as getBlockedNetworkModeReason, rn as loadConfig } from "./model-selection-Dovilo6b.js";
import { t as formatCliCommand } from "./command-format-3Z_Kl5PP.js";
import { t as CHANNEL_IDS } from "./registry-D5r9Pc2H.js";
import { $ as canonicalizeMainSessionAlias, ct as acquireSessionWriteLock, et as resolveAgentMainSessionKey } from "./sessions-DTVAB3HG.js";
import { a as resolveCoreToolProfilePolicy, t as CORE_TOOL_GROUPS } from "./tool-catalog-Dm7UDWav.js";
import { G as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, W as DEFAULT_OPENCLAW_BROWSER_COLOR } from "./chrome-zmDkfOk2.js";
import { i as isLoopbackHost } from "./ws-BSKgXzsx.js";
import { a as resolveProfile, c as resolveBrowserControlAuth, o as deriveDefaultBrowserCdpPortRange, r as registerBrowserRoutes, s as ensureBrowserControlAuth, t as createBrowserRouteContext } from "./server-context-BrHTnAHF.js";
import { i as sanitizeEnvVars } from "./env-overrides-lUwusxOI.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-WL7vop6P.js";
import { d as resolveSandboxInputPath, f as resolveSandboxPath, o as syncSkillsToWorkspace } from "./skills-D9zp-Tdj.js";
import { n as installBrowserCommonMiddleware, t as installBrowserAuthMiddleware } from "./server-middleware-CiGUwte4.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-CJqMZywT.js";
