import { _ as danger, t as createSubsystemLogger, x as logVerbose } from "./subsystem-kzdGVyce.js";
import { _ as expandHomePrefix } from "./paths-BfR2LXbA.js";
import { r as isTruthyEnvValue } from "./entry.js";
import { H as loadConfig, K as readConfigFileSnapshotForWrite, Rn as resolveTelegramPreviewStreamMode, X as writeConfigFile } from "./auth-profiles-UpqQjKB-.js";
import { _ as normalizeAccountId } from "./session-key-GuEQvqMH.js";
import { t as CONFIG_DIR } from "./utils-B4wShrgI.js";
import { u as resolveTelegramAccount } from "./plugins-v0UiRqAc.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-Bs2wAwrn.js";
import { h as normalizeMimeType, m as kindFromMime, p as isGifMedia, u as getFileExtension } from "./image-ops-BZX4S9OA.js";
import { t as hasProxyEnvConfigured } from "./proxy-env-DBXIh4R2.js";
import { n as redactSensitiveText } from "./redact-b9XS0Muh.js";
import { i as formatUncaughtError, n as extractErrorCode, r as formatErrorMessage, s as readErrorName, t as collectErrorGraphCandidates } from "./errors-oTqWODa8.js";
import { t as makeProxyFetch } from "./proxy-fetch-BJuVlAGN.js";
import { a as loadWebMedia, n as markdownToIR, s as resolveMarkdownTableMode, t as chunkMarkdownIR } from "./ir-MPXYeM9z.js";
import { t as renderMarkdownWithMarkers } from "./render-DT-umBSz.js";
import { t as resolveFetch } from "./fetch-Q5enmqDF.js";
import { i as readChannelAllowFromStore } from "./pairing-store-v0j3oBoa.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-CoKobep6.js";
...
import { n as isSenderIdAllowed, r as mergeDmAllowFromSources, t as firstDefined } from "./allow-from-ChG8SFos.js";
import { n as isWSL2Sync } from "./wsl-Dz64QC9N.js";
...
//#endregion
export { describeReplyTarget as A, resolveTelegramReplyId as B, buildSenderLabel as C, buildTelegramParentPeer as D, buildTelegramGroupPeerId as E, normalizeForwardedContext as F, normalizeDmAllowFromWithStore as G, resolveTelegramThreadSpec as H, resolveTelegramDirectPeerId as I, toLocationContext as J, resolveSenderAllowMatch as K, resolveTelegramForumThreadId as L, extractTelegramLocation as M, getTelegramTextParts as N, buildTelegramThreadParams as O, hasBotMention as P, resolveTelegramGroupAllowFromContext as R, buildGroupLabel as S, buildTelegramGroupFrom as T, isSenderAllowed as U, resolveTelegramStreamMode as V, normalizeAllowFrom as W, isVoiceCompatibleAudio as Y, splitTelegramCaption as _, reactMessageTelegram as a, resolveCronStorePath as b, sendStickerTelegram as c, isRecoverableTelegramNetworkError as d, markdownToTelegramChunks as f, resolveTelegramFetch as g, wrapFileReferencesInHtml as h, editMessageTelegram as i, expandTextLinks as j, buildTypingThreadParams as k, resolveTelegramVoiceSend as l, renderTelegramHtmlText as m, createForumTopicTelegram as n, sendMessageTelegram as o, markdownToTelegramHtml as p, formatLocationText as q, deleteMessageTelegram as r, sendPollTelegram as s, buildInlineKeyboard as t, wasSentByBot as u, withTelegramApiErrorLogging as v, buildSenderName as w, saveCronStore as x, loadCronStore as y, resolveTelegramMediaPlaceholder as z };
