import { _ as normalizeHyphenSlug, i as resolveAgentConfig, p as resolveSessionAgentId } from "./run-with-concurrency-CLqOp5Ex.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-DkxwiA8g.js";
import { a as defaultRuntime, t as createSubsystemLogger } from "./subsystem-C9Gk4AAH.js";
import { B as resolveAgentIdFromSessionKey, N as buildAgentMainSessionKey, R as normalizeAgentId, T as resolvePathViaExistingAncestorSync, _ as runExec, a as DEFAULT_IDENTITY_FILENAME, b as openBoundaryFile, c as DEFAULT_USER_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, j as DEFAULT_AGENT_ID, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, q as normalizeOptionalAccountId, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME, z as normalizeMainKey } from "./workspace-Cn3fdLBW.js";
import { E as truncateUtf16Safe, h as normalizeE164, y as resolveUserPath } from "./logger-CJbXRTpA.js";
import { $ as loadConfig, $n as containsEnvVarReference, Cr as hasConfiguredSecretInput, Er as resolveSecretInputRef, G as resolveSecretRefValues, Kt as CHANNEL_IDS, X as createConfigIO, _r as formatCliCommand, _t as secretRefKey, bt as parseByteSize, gr as isPidAlive, hr as getProcessStartTime, it as writeConfigFile, mr as resolveProcessScopedMap, vt as getBlockedNetworkModeReason, yt as parseDurationMs } from "./model-selection-C8ExQCsd.js";
import { c as parseBooleanValue } from "./legacy-names-dyOVyQ4G.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-iS7Vx60r.js";
import { r as normalizeChannelId, y as normalizeChatType } from "./plugins-GLBgHzdU.js";
import { t as generateSecureToken } from "./secure-random-B_aylR4q.js";
import { i as getImageMetadata, m as normalizeMessageChannel, n as buildImageResizeSideGrid, p as listDeliverableMessageChannels, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-BnQjE9aK.js";
import { $ as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, A as resolveExistingPathsWithinRoot, B as BrowserTargetAmbiguousError, D as DEFAULT_DOWNLOAD_DIR, F as BrowserProfileNotFoundError, H as toBrowserErrorResponse, I as BrowserProfileUnavailableError, J as withBrowserNavigationPolicy, K as assertBrowserNavigationResultAllowed, L as BrowserResetUnsupportedError, M as resolveWritablePathWithinRoot, N as BrowserConfigurationError, O as DEFAULT_TRACE_DIR, P as BrowserConflictError, R as BrowserResourceExhaustedError, S as CDP_JSON_NEW_TIMEOUT_MS, U as InvalidBrowserNavigationUrlError, V as BrowserValidationError, W as assertBrowserNavigationAllowed, X as normalizeBrowserFormField, Z as isLoopbackHost, a as resolveOpenClawUserDataDir, b as ensureChromeExtensionRelayServer, c as resolveBrowserExecutableForPlatform, et as DEFAULT_AI_SNAPSHOT_MAX_CHARS, f as normalizeCdpWsUrl, g as fetchOk, h as fetchJson, i as launchOpenClawChrome, k as DEFAULT_UPLOAD_DIR, l as captureScreenshot, m as appendCdpPath, n as isChromeCdpReady, nt as DEFAULT_OPENCLAW_BROWSER_COLOR, o as stopOpenClawChrome, p as snapshotAria, q as requiresInspectableBrowserNavigationRedirects, r as isChromeReachable, rt as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as createTargetViaCdp, v as normalizeCdpHttpBaseForJsonEndpoints, w as resolveCdpReachabilityTimeouts, x as stopChromeExtensionRelayServer, z as BrowserTabNotFoundError } from "./chrome-CsliCm3w.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-B2xU2F7d.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Btg2RyAC.js";
import { n as SsrFBlockedError } from "./proxy-env-C2KrBwJo.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-CH6uzT9l.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-Ckne-lqQ.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-C1Nvew4C.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-2lGNRIr-.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-u6SI4r8Z.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BgGkIBR2.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-Ox4B6iGw.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-B0Z4EOJv.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-B0Z4EOJv.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
//#endregion
export { parseFiniteNumber as $, normalizeToolName as $t, isRawApiErrorPayload as A, deriveSessionMetaPatch as At, resolveMirroredTranscriptText as B, ensureBrowserControlAuth as Bt, isCloudCodeAssistFormatError as C, mergeSessionEntry as Ct, isFailoverErrorMessage as D, resolveAgentMainSessionKey as Dt, isFailoverAssistantError as E, canonicalizeMainSessionAlias as Et, isTimeoutErrorMessage as F, createBrowserRouteContext as Ft, readSessionUpdatedAt as G, resolveSandboxConfigForAgent as Gt, resolveAndPersistSessionFile as H, GatewaySecretRefUnavailableError as Ht, ensureSandboxWorkspaceForSession as I, registerBrowserRoutes as It, updateLastRoute as J, collectExplicitAllowlist as Jt, recordSessionMetaFromInbound as K, applyOwnerOnlyToolPolicy as Kt, resolveSandboxContext as L, resolveBrowserConfig as Lt, parseImageDimensionError as M, resolveGroupSessionKey as Mt, parseImageSizeError as N, acquireSessionWriteLock as Nt, isLikelyContextOverflowError as O, resolveExplicitAgentSessionKey as Ot, sanitizeUserFacingText as P, resolveSessionLockMaxHoldFromTimeout as Pt, resolveCacheTtlMs as Q, expandToolGroups as Qt, resolveSandboxRuntimeStatus as R, resolveProfile as Rt, isBillingAssistantError as S, DEFAULT_RESET_TRIGGERS as St, isContextOverflowError as T, setSessionRuntimeModel as Tt, extractDeliveryInfo as U, resolveGatewayCredentialsFromConfig as Ut, resolveSessionTranscriptFile as V, resolveBrowserControlAuth as Vt, loadSessionStore as W, trimToUndefined$1 as Wt, updateSessionStoreEntry as X, mergeAlsoAllowPolicy as Xt, updateSessionStore as Y, expandPolicyWithPluginGroups as Yt, isCacheEnabled as Z, stripPluginOnlyAllowlist as Zt, formatAssistantErrorText as _, evaluateSessionFreshness as _t, isMessagingToolDuplicateNormalized as a, resolveBootstrapMaxChars as an, normalizeAccountId as at, getApiErrorPayloadFingerprint as b, resolveSessionResetType as bt, extractToolCallsFromAssistant as c, sanitizeGoogleTurnOrdering as cn, countToolResults as ct, downgradeOpenAIFunctionCallReasoningPairs as d, INPUT_PROVENANCE_KIND_VALUES as dt, resolveToolProfilePolicy as en, deliveryContextFromSession as et, downgradeOpenAIReasoningBlocks as f, applyInputProvenanceToUserMessage as ft, classifyFailoverReasonFromHttpStatus as g, resolveSessionKey as gt, classifyFailoverReason as h, jsonUtf8Bytes as ht, isMessagingToolDuplicate as i, ensureSessionHeader$1 as in, normalizeSessionDeliveryFields as it, isTransientHttpError as j, resolveConversationLabel as jt, isRateLimitAssistantError as k, resolveMainSessionKey as kt, extractToolResultId as l, extractToolCallNames as lt, BILLING_ERROR_USER_MESSAGE as m, normalizeInputProvenance as mt, validateGeminiTurns as n, matchesAnyGlobPattern as nn, mergeDeliveryContext as nt, normalizeTextForComparison as o, resolveBootstrapPromptTruncationWarningMode as on, archiveSessionTranscripts as ot, isGoogleModelApi as p, hasInterSessionUserProvenance as pt, resolveSessionStoreEntry as q, buildPluginToolGroups as qt, pickFallbackThinkingLevel as r, buildBootstrapContextFiles as rn, normalizeDeliveryContext as rt, sanitizeSessionMessagesImages as s, resolveBootstrapTotalMaxChars as sn, capArrayByJsonBytes as st, validateAnthropicTurns as t, compileGlobPatterns as tn, deliveryContextKey as tt, sanitizeToolCallIdsForCloudCodeAssist as u, parseInlineDirectives as ut, formatBillingErrorMessage as v, resolveChannelResetConfig as vt, isCompactionFailureError as w, resolveFreshSessionTotalTokens as wt, isAuthAssistantError as x, resolveThreadFlag as xt, formatRawAssistantErrorForUi as y, resolveSessionResetPolicy as yt, appendAssistantMessageToSessionTranscript as z, getBridgeAuthForPort as zt };
