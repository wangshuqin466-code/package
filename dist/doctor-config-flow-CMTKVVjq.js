import { f as resolveLegacyStateDirs, g as resolveStateDir, m as resolveOAuthDir, p as resolveNewStateDir, t as CONFIG_PATH } from "./paths-BfR2LXbA.js";
import { Fn as resolveDiscordPreviewStreamMode, G as readConfigFileSnapshot, In as resolveSlackNativeStreaming, L as migrateLegacyConfig, Ln as resolveSlackStreamingMode, Mn as formatSlackStreamModeMigrationMessage, Nn as formatSlackStreamingBooleanMigrationMessage, Q as OpenClawSchema, Qt as normalizeTrustedSafeBinDirs, Rn as resolveTelegramPreviewStreamMode, Xt as isTrustedSafeBinPath, Yt as getTrustedSafeBinDirs, ln as resolveCommandResolutionFromArgv } from "./auth-profiles-UpqQjKB-.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { f as resolveDefaultAgentId } from "./agent-scope-BDXYqF89.js";
import { _ as normalizeAccountId, c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey, v as normalizeOptionalAccountId } from "./session-key-GuEQvqMH.js";
import { g as resolveHomeDir, u as isRecord } from "./utils-B4wShrgI.js";
import { l as normalizeChatChannelId } from "./registry-Gs6xb3DK.js";
import { u as parseToolsBySenderTypedKey } from "./dock-6TSCZqEs.js";
import { a as inspectTelegramAccount, c as listTelegramAccountIds, h as formatSetExplicitDefaultToConfiguredInstruction, m as formatSetExplicitDefaultInstruction, p as formatChannelAccountsDefaultPath, u as resolveTelegramAccount, x as listRouteBindings } from "./plugins-v0UiRqAc.js";
import { Q as canonicalizeMainSessionAlias, f as saveSessionStore } from "./sessions-Bh025Q5O.js";
...
import { i as readChannelAllowFromStore, s as resolveChannelAllowFromPath } from "./pairing-store-v0j3oBoa.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-Djxxngde.js";
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-CSWZvueS.js";
