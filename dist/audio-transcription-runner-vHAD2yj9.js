import { b as resolveAgentModelFallbackValues, x as resolveAgentModelPrimaryValue } from "./run-with-concurrency-CLqOp5Ex.js";
import { T as resolvePreferredOpenClawTmpDir, d as logVerbose, m as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-C9Gk4AAH.js";
import { _ as runExec } from "./workspace-Cn3fdLBW.js";
import { $ as loadConfig, S as resolveApiKeyForProvider, c as normalizeProviderId, dt as mergeInboundPathRoots, fr as resolveOpenClawAgentDir, ft as resolveIMessageAttachmentRoots, g as normalizeGoogleModelId, lt as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, ut as isInboundPathAllowed, x as requireApiKey } from "./model-selection-C8ExQCsd.js";
import { y as normalizeChatType } from "./plugins-GLBgHzdU.js";
import { E as kindFromMime, S as getFileExtension, b as detectMime, w as isAudioFileName } from "./image-ops-BnQjE9aK.js";
import { E as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-C9KB_ouZ.js";
import { a as getDefaultMediaLocalRoots, n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-B4gJ77w9.js";
import { n as fetchWithTimeout } from "./fetch-timeout-idp6LTKB.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DclAx9Ee.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-cSqbom_f.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-53_Tkfsi.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-RxA0bewA.js").then((n) => n.r);
