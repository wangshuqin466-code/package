...
import { D as colorize, O as isRich$1, k as theme } from "./subsystem-kzdGVyce.js";
import { $n as setAuthProfileOrder, Ar as resolveDefaultModelForAgent, Bi as resolveAuthProfileDisplayLabel, Er as parseModelRef, Gr as resolveEnvApiKey, H as loadConfig, J as setRuntimeConfigSnapshot, K as readConfigFileSnapshotForWrite, Mr as resolveModelRefFromString, Ri as DEFAULT_MODEL, Si as isNonSecretApiKeyMarker, Sr as modelKey, Tr as normalizeProviderId, Ur as resolveApiKeyForProvider, Vr as getCustomProviderApiKey, Wr as resolveAwsSdkEnvVarName, Xr as shouldEnableShellEnvFallback, Zn as listProfilesForProvider, _r as buildModelAliasIndex, er as upsertAuthProfile, kr as resolveConfiguredModelRef, l as resolveProfileUnusableUntilForDisplay, lr as resolveAuthStorePathForDisplay, mt as parseDurationMs, n as resolveAuthProfileEligibility, qr as getShellEnvAppliedKeys, r as resolveAuthProfileOrder, rr as ensureAuthProfileStore, ur as resolveOpenClawAgentDir, vr as findNormalizedProviderValue, y as resolveSecretRefString, z as createConfigIO, zi as DEFAULT_PROVIDER } from "./auth-profiles-UpqQjKB-.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-BDXYqF89.js";
...
import { $t as formatUsageWindowSummary, Bt as DEFAULT_OAUTH_WARN_MS, Ht as formatRemainingShort, Ir as resolveModelWithRegistry, Qn as runEmbeddedPiAgent, Vt as buildAuthHealthSummary, Zt as loadProviderUsageSummary, en as resolveUsageProviderId, fr as describeFailoverError, zt as maskApiKey } from "./compact-D3emcZgv.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CHZFD2LJ.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-D3cXuvcv.js";
import { n as loadModelCatalog } from "./model-catalog-RhG2KE3w.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-tuZ5jpnm.js";
import { f as openUrl } from "./onboard-helpers-Be9c-Ktq.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DMLxb9pN.js";
import { r as withProgressTotals } from "./progress-BVJ8qDnh.js";
import { t as createClackPrompter } from "./clack-prompter-G-XGtgN3.js";
import { t as renderTable } from "./table-o9Qa9g3_.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-Yl2mFcXx.js";
import { n as redactSecrets } from "./format-pnA4o_aH.js";
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-Bu6NcJlO.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-Do96RqJu.js";
import { n as logConfigUpdated } from "./logging-BvRxc8kO.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-CImFYkH3.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-UpqQjKB-.js").then((n) => n.t);
	const { ensureOpenClawModelsJson } = await import("./models-config-Ct5bZG7t.js").then((n) => n.n);
