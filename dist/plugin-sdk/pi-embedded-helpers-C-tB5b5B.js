import { I as resolvePathViaExistingAncestorSync, O as runExec, Q as buildAgentMainSessionKey, S as ensureAgentWorkspace, X as DEFAULT_AGENT_ID, _ as DEFAULT_HEARTBEAT_FILENAME, at as resolveAgentIdFromSessionKey, b as DEFAULT_TOOLS_FILENAME, dt as normalizeOptionalAccountId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeMainKey, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, q as normalizeHyphenSlug, rt as normalizeAgentId, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-CvBOjUE3.js";
import { Bn as resolveProcessScopedMap, C as parseDurationMs, Dn as resolveSecretRefValues, Hn as isPidAlive, It as containsEnvVarReference, Pr as formatCliCommand, S as getBlockedNetworkModeReason, Vn as getProcessStartTime, i as loadConfig, ir as secretRefKey, l as writeConfigFile, lr as resolveSecretInputRef, nr as parseBooleanValue, or as hasConfiguredSecretInput, t as createConfigIO, ur as CHANNEL_IDS, w as parseByteSize } from "./config-upduwSBz.js";
import { E as truncateUtf16Safe, M as defaultRuntime, O as createSubsystemLogger, h as normalizeE164, y as resolveUserPath } from "./logger-CyvuRp4f.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-D6tDENa_.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-f1v1_i9D.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-B4aBdZa6.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-CSd6ioRA.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-0c91o_Js.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-sMOjdggg.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-BSnO1qS4.js";
import { $ as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, A as resolveExistingPathsWithinRoot, B as BrowserTargetAmbiguousError, D as DEFAULT_DOWNLOAD_DIR, F as BrowserProfileNotFoundError, H as toBrowserErrorResponse, I as BrowserProfileUnavailableError, J as withBrowserNavigationPolicy, K as assertBrowserNavigationResultAllowed, L as BrowserResetUnsupportedError, M as resolveWritablePathWithinRoot, N as BrowserConfigurationError, O as DEFAULT_TRACE_DIR, P as BrowserConflictError, R as BrowserResourceExhaustedError, S as CDP_JSON_NEW_TIMEOUT_MS, U as InvalidBrowserNavigationUrlError, V as BrowserValidationError, W as assertBrowserNavigationAllowed, X as normalizeBrowserFormField, Z as isLoopbackHost, a as resolveOpenClawUserDataDir, b as ensureChromeExtensionRelayServer, c as resolveBrowserExecutableForPlatform, et as DEFAULT_AI_SNAPSHOT_MAX_CHARS, f as normalizeCdpWsUrl, g as fetchOk, h as fetchJson, i as launchOpenClawChrome, k as DEFAULT_UPLOAD_DIR, l as captureScreenshot, m as appendCdpPath, n as isChromeCdpReady, nt as DEFAULT_OPENCLAW_BROWSER_COLOR, o as stopOpenClawChrome, p as snapshotAria, q as requiresInspectableBrowserNavigationRedirects, r as isChromeReachable, rt as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as createTargetViaCdp, v as normalizeCdpHttpBaseForJsonEndpoints, w as resolveCdpReachabilityTimeouts, x as stopChromeExtensionRelayServer, z as BrowserTabNotFoundError } from "./chrome-CN1wAraE.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-DrcY1qHs.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-RSyiESJ8.js";
import { n as SsrFBlockedError } from "./proxy-env-BR0_ihdh.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-C6T03XVS.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-XqCQC_cj.js";
import { t as generateSecureToken } from "./secure-random-C48xAdD5.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-BJ0tGQwz.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-BswvL9EH.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BN-kQckp.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-BN-kQckp.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
