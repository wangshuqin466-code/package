import { E as kindFromMime, S as getFileExtension, b as detectMime, w as isAudioFileName } from "./message-channel-BfBFtOb7.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, X as resolvePreferredOpenClawTmpDir } from "./utils-B0IyLNx9.js";
import { B as resolveAgentModelFallbackValues, V as resolveAgentModelPrimaryValue, vt as runExec } from "./run-with-concurrency-C-4lcmuz.js";
import { y as normalizeChatType } from "./plugins-QUFoiGWF.js";
import { B as resolveIMessageAttachmentRoots, D as loadConfig, L as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, R as isInboundPathAllowed, Un as resolveOpenClawAgentDir, cr as normalizeGoogleModelId, i as resolveApiKeyForProvider, r as requireApiKey, tr as normalizeProviderId, z as mergeInboundPathRoots } from "./model-auth-D4ii__OS.js";
import { n as fetchWithTimeout } from "./fetch-timeout-DpvMOIrx.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DEbABfDW.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-CBzz5qrG.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-C3qC4Vhi.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-K3pRu4OE.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-BKb1uyZt.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-D3UcDK3V.js").then((n) => n.r);
