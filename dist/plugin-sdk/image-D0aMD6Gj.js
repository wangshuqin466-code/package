import { _t as resolveAgentModelFallbackValues, vt as resolveAgentModelPrimaryValue } from "./run-with-concurrency-CF8VuJbn.js";
import { f as isRecord, x as shortenHomeInString } from "./logger-BMLgyw16.js";
import { E as loadConfig, Fn as resolveImplicitProviders, Pn as normalizeProviders, T as getRuntimeConfigSourceSnapshot, Tn as normalizeModelRef, Un as isNonSecretApiKeyMarker, Zn as normalizeSecretInput, in as createConfigRuntimeEnv, mn as resolveOpenClawAgentDir, r as requireApiKey, t as getApiKeyForModel, w as getRuntimeConfigSnapshot } from "./model-auth-XFaDx11U.js";
import { P as sanitizeUserFacingText } from "./pi-embedded-helpers-E84qlHCL.js";
import { n as redactToolDetail } from "./redact-CuadQs4H.js";
...
function loadPiModelDiscoveryRuntime() {
	piModelDiscoveryRuntimePromise ??= import("./pi-model-discovery-runtime-BH6hmq0A.js");
...
async function describeImageWithModel(params) {
	...
	if (isMinimaxVlmModel(model.provider, model.id)) return {
