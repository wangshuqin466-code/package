...
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-iKJ_iGg6.js";
import { C as createConfigIO, E as loadConfig, Fr as resolveSecretInputRef, G as parseDurationMs, K as parseByteSize, Mr as hasConfiguredSecretInput, W as getBlockedNetworkModeReason, _n as getProcessStartTime, an as containsEnvVarReference, dr as secretRefKey, gn as resolveProcessScopedMap, j as writeConfigFile, kr as formatCliCommand, lr as parseBooleanValue, tr as CHANNEL_IDS, v as resolveSecretRefValues, vn as isPidAlive } from "./model-auth-XFaDx11U.js";
import { r as normalizeChannelId, y as normalizeChatType } from "./plugins-DsJt7fJ_.js";
import { t as SsrFBlockedError } from "./ssrf-DO4nukNa.js";
import { g as getImageMetadata, m as buildImageResizeSideGrid, o as listDeliverableMessageChannels, p as IMAGE_REDUCE_QUALITY_STEPS, s as normalizeMessageChannel, y as resizeToJpeg } from "./message-channel-B0AAGrsT.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Chm5u0m0.js";
import { a as saveMediaBuffer, n as ensureMediaDir } from "./store-BjPGnmu2.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-D-3S0Vvs.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-DLwa5lSY.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DutjVURS.js";
import { $ as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, A as resolveExistingPathsWithinRoot, B as BrowserTargetAmbiguousError, D as DEFAULT_DOWNLOAD_DIR, F as BrowserProfileNotFoundError, H as toBrowserErrorResponse, I as BrowserProfileUnavailableError, J as withBrowserNavigationPolicy, K as assertBrowserNavigationResultAllowed, L as BrowserResetUnsupportedError, M as resolveWritablePathWithinRoot, N as BrowserConfigurationError, O as DEFAULT_TRACE_DIR, P as BrowserConflictError, R as BrowserResourceExhaustedError, S as CDP_JSON_NEW_TIMEOUT_MS, U as InvalidBrowserNavigationUrlError, V as BrowserValidationError, W as assertBrowserNavigationAllowed, X as normalizeBrowserFormField, Z as isLoopbackHost, a as resolveOpenClawUserDataDir, b as ensureChromeExtensionRelayServer, c as resolveBrowserExecutableForPlatform, et as DEFAULT_AI_SNAPSHOT_MAX_CHARS, f as normalizeCdpWsUrl, g as fetchOk, h as fetchJson, i as launchOpenClawChrome, k as DEFAULT_UPLOAD_DIR, l as captureScreenshot, m as appendCdpPath, n as isChromeCdpReady, nt as DEFAULT_OPENCLAW_BROWSER_COLOR, o as stopOpenClawChrome, p as snapshotAria, q as requiresInspectableBrowserNavigationRedirects, r as isChromeReachable, rt as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as createTargetViaCdp, v as normalizeCdpHttpBaseForJsonEndpoints, w as resolveCdpReachabilityTimeouts, x as stopChromeExtensionRelayServer, z as BrowserTabNotFoundError } from "./chrome-DuUe2cfN.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-BKG9RF4P.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-aHHLVEoW.js";
import { t as generateSecureToken } from "./secure-random-CaLg2Lm4.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-BhtEB_pL.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-CIpFsb0x.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BDN4Pf16.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-BDN4Pf16.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
//#endregion
export { expandPolicyWithPluginGroups as $, mergeSessionEntry as $t, isRawApiErrorPayload as A, mergeDeliveryContext as At, registerBrowserRoutes as B, applyInputProvenanceToUserMessage as Bt, isCloudCodeAssistFormatError as C, updateSessionStore as Ct, isFailoverErrorMessage as D, parseFiniteNumber as Dt, isFailoverAssistantError as E, resolveCacheTtlMs as Et, isTimeoutErrorMessage as F, capArrayByJsonBytes as Ft, resolveBrowserControlAuth as G, resolveSessionLockMaxHoldFromTimeout as Gt, resolveProfile as H, normalizeInputProvenance as Ht, ensureSandboxWorkspaceForSession as I, countToolResults as It, trimToUndefined$1 as J, resolveChannelResetConfig as Jt, GatewaySecretRefUnavailableError as K, resolveSessionKey as Kt, resolveSandboxContext as L, extractToolCallNames as Lt, parseImageDimensionError as M, normalizeSessionDeliveryFields as Mt, parseImageSizeError as N, normalizeAccountId as Nt, isLikelyContextOverflowError as O, deliveryContextFromSession as Ot, sanitizeUserFacingText as P, archiveSessionTranscripts as Pt, collectExplicitAllowlist as Q, DEFAULT_RESET_TRIGGERS as Qt, resolveSandboxRuntimeStatus as R, parseInlineDirectives as Rt, isBillingAssistantError as S, updateLastRoute as St, isContextOverflowError as T, isCacheEnabled as Tt, getBridgeAuthForPort as U, jsonUtf8Bytes as Ut, resolveBrowserConfig as V, hasInterSessionUserProvenance as Vt, ensureBrowserControlAuth as W, acquireSessionWriteLock as Wt, applyOwnerOnlyToolPolicy as X, resolveSessionResetType as Xt, resolveSandboxConfigForAgent as Y, resolveSessionResetPolicy as Yt, buildPluginToolGroups as Z, resolveThreadFlag as Zt, formatAssistantErrorText as _, extractDeliveryInfo as _t, isMessagingToolDuplicateNormalized as a, deriveSessionMetaPatch as an, compileGlobPatterns as at, getApiErrorPayloadFingerprint as b, recordSessionMetaFromInbound as bt, extractToolCallsFromAssistant as c, ensureSessionHeader as ct, downgradeOpenAIFunctionCallReasoningPairs as d, resolveBootstrapTotalMaxChars as dt, resolveFreshSessionTotalTokens as en, mergeAlsoAllowPolicy as et, downgradeOpenAIReasoningBlocks as f, sanitizeGoogleTurnOrdering as ft, classifyFailoverReasonFromHttpStatus as g, resolveAndPersistSessionFile as gt, classifyFailoverReason as h, resolveSessionTranscriptFile as ht, isMessagingToolDuplicate as i, resolveMainSessionKey as in, resolveToolProfilePolicy as it, isTransientHttpError as j, normalizeDeliveryContext as jt, isRateLimitAssistantError as k, deliveryContextKey as kt, extractToolResultId as l, resolveBootstrapMaxChars as lt, BILLING_ERROR_USER_MESSAGE as m, resolveMirroredTranscriptText as mt, validateGeminiTurns as n, canonicalizeMainSessionAlias as nn, expandToolGroups as nt, normalizeTextForComparison as o, resolveConversationLabel as on, matchesAnyGlobPattern as ot, isGoogleModelApi as p, appendAssistantMessageToSessionTranscript as pt, resolveGatewayCredentialsFromConfig as q, evaluateSessionFreshness as qt, pickFallbackThinkingLevel as r, resolveExplicitAgentSessionKey as rn, normalizeToolName as rt, sanitizeSessionMessagesImages as s, resolveGroupSessionKey as sn, buildBootstrapContextFiles as st, validateAnthropicTurns as t, setSessionRuntimeModel as tn, stripPluginOnlyAllowlist as tt, sanitizeToolCallIdsForCloudCodeAssist as u, resolveBootstrapPromptTruncationWarningMode as ut, formatBillingErrorMessage as v, loadSessionStore as vt, isCompactionFailureError as w, updateSessionStoreEntry as wt, isAuthAssistantError as x, resolveSessionStoreEntry as xt, formatRawAssistantErrorForUi as y, readSessionUpdatedAt as yt, createBrowserRouteContext as z, INPUT_PROVENANCE_KIND_VALUES as zt };
