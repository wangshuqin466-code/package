import { J as resolveAgentModelPrimaryValue, O as runExec, q as resolveAgentModelFallbackValues } from "./run-with-concurrency-tODp1hy3.js";
import { x as normalizeChatType } from "./plugins-e62olPre.js";
import { B as resolveIMessageAttachmentRoots, D as loadConfig, L as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, R as isInboundPathAllowed, Yn as resolveOpenClawAgentDir, i as resolveApiKeyForProvider, mr as normalizeGoogleModelId, r as requireApiKey, sr as normalizeProviderId, z as mergeInboundPathRoots } from "./model-auth-BQ4Cp3j8.js";
...
import { n as fetchWithTimeout } from "./fetch-timeout-CmQnOXfj.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DqcetWYz.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-BrTKipfG.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-Cj2Jg3ch.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-CnwWrazx.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DR4GvGT2.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DUEz1g-Y.js").then((n) => n.r);
