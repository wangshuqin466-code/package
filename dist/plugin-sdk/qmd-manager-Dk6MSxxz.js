import { c as resolveAgentWorkspaceDir, vt as parseAgentSessionKey } from "./run-with-concurrency-tODp1hy3.js";
import { O as createSubsystemLogger } from "./logger-D-NoZ0-e.js";
...
import { c as writeFileWithinRoot } from "./fs-safe-CfCxUVsz.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-D4wZtuQE.js";
import { _ as statRegularFile, g as isFileMissingError, n as buildSessionEntry, r as listSessionFilesForAgent, t as requireNodeSqlite, v as extractKeywords } from "./sqlite-BW3YgB8E.js";
...
function isWindowsCommandShimEinval(params) {
	if (process.platform !== "win32") return false;
	if (params.err?.code !== "EINVAL") return false;
...
var QmdMemoryManager = class QmdMemoryManager {
	...
	*/
	...
	async runMcporter(args, opts) {
		const runWithInvocation = async (spawnInvocation) => await runCliCommand({
