import { st as normalizeAccountId } from "./run-with-concurrency-CF8VuJbn.js";
import { c as resolveStateDir, d as resolveRequiredHomeDir, l as expandHomePrefix, o as resolveOAuthDir } from "./paths-DinMprTu.js";
import { I as danger, O as createSubsystemLogger, R as logVerbose, a as CONFIG_DIR, b as safeParseJson } from "./logger-BMLgyw16.js";
import { E as loadConfig, O as readConfigFileSnapshotForWrite, cr as isTruthyEnvValue, hn as withFileLock$1, j as writeConfigFile, nn as resolveTelegramPreviewStreamMode } from "./model-auth-XFaDx11U.js";
import { c as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-DsJt7fJ_.js";
import { l as hasProxyEnvConfigured } from "./ssrf-DO4nukNa.js";
import { D as normalizeMimeType, E as kindFromMime, S as getFileExtension, T as isGifMedia } from "./message-channel-B0AAGrsT.js";
import { r as writeJsonAtomic } from "./json-files-D-3S0Vvs.js";
import { _ as loadWebMedia, i as resolveMarkdownTableMode, n as markdownToIR, t as chunkMarkdownIR } from "./ir-zNw6Of4b.js";
import { t as redactSensitiveText } from "./redact-CuadQs4H.js";
import { i as formatUncaughtError, n as extractErrorCode, o as readErrorName, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-aHHLVEoW.js";
import { t as makeProxyFetch } from "./proxy-fetch-DmIpD5u2.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-ByB5-FPs.js";
import { t as renderMarkdownWithMarkers } from "./render-hUn-4tdL.js";
...
import { t as resolveFetch } from "./fetch-CUEducDz.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-CArz9dwZ.js";
...
//#endregion
export { readJsonFileWithFallback as $, expandTextLinks as A, resolveTelegramStreamMode as B, buildSenderName as C, buildTelegramThreadParams as D, buildTelegramParentPeer as E, resolveTelegramDirectPeerId as F, resolveSenderAllowMatch as G, isSenderAllowed as H, resolveTelegramForumThreadId as I, isVoiceCompatibleAudio as J, formatLocationText as K, resolveTelegramGroupAllowFromContext as L, getTelegramTextParts as M, hasBotMention as N, buildTypingThreadParams as O, normalizeForwardedContext as P, upsertChannelPairingRequest as Q, resolveTelegramMediaPlaceholder as R, buildSenderLabel as S, buildTelegramGroupPeerId as T, normalizeAllowFrom as U, resolveTelegramThreadSpec as V, normalizeDmAllowFromWithStore as W, readChannelAllowFromStore as X, addChannelAllowFromStoreEntry as Y, removeChannelAllowFromStoreEntry as Z, wrapFileReferencesInHtml as _, reactMessageTelegram as a, mergeDmAllowFromSources as at, withTelegramApiErrorLogging as b, sendStickerTelegram as c, resolveCronStorePath as d, writeJsonFileAtomically as et, wasSentByBot as f, renderTelegramHtmlText as g, markdownToTelegramHtml as h, editMessageTelegram as i, isSenderIdAllowed as it, extractTelegramLocation as j, describeReplyTarget as k, resolveTelegramVoiceSend as l, markdownToTelegramChunks as m, createForumTopicTelegram as n, listPairingChannels as nt, sendMessageTelegram as o, resolveGroupAllowFromSources as ot, isRecoverableTelegramNetworkError as p, toLocationContext as q, deleteMessageTelegram as r, firstDefined as rt, sendPollTelegram as s, buildInlineKeyboard as t, getPairingAdapter as tt, loadCronStore as u, resolveTelegramFetch as v, buildTelegramGroupFrom as w, buildGroupLabel as x, splitTelegramCaption as y, resolveTelegramReplyId as z };
