import { I as resolvePathViaExistingAncestorSync, O as runExec, Q as buildAgentMainSessionKey, S as ensureAgentWorkspace, W as normalizeHyphenSlug, X as DEFAULT_AGENT_ID, _ as DEFAULT_HEARTBEAT_FILENAME, at as resolveAgentIdFromSessionKey, b as DEFAULT_TOOLS_FILENAME, dt as normalizeOptionalAccountId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeMainKey, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, rt as normalizeAgentId, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-2ga3-CMk.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-eFexkPEh.js";
import { Br as formatCliCommand, Er as secretRefKey, G as parseDurationMs, K as parseByteSize, Lr as resolveProcessScopedMap, On as containsEnvVarReference, Qr as resolveSecretInputRef, Rr as getProcessStartTime, W as getBlockedNetworkModeReason, bt as CHANNEL_IDS, ci as parseBooleanValue, i as loadConfig, l as writeConfigFile, qr as hasConfiguredSecretInput, t as createConfigIO, yr as resolveSecretRefValues, zr as isPidAlive } from "./config-DiiPndBn.js";
import { C as normalizeE164, D as resolveUserPath, P as truncateUtf16Safe, a as createSubsystemLogger, l as defaultRuntime } from "./logger-U3s76KST.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-CfIPyoMg.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-ZjRT9yvG.js";
import { gt as normalizeChatType, r as normalizeChannelId } from "./plugins-Bhm3N6Y-.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-yc45qYMp.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-CjSurXWk.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-UHZB-rie.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-DR1SiaHP.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-DFv45kR8.js";
import { t as SsrFBlockedError } from "./ssrf-D6FSPiLK.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-DGP_dM0r.js";
import { $ as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, A as resolveExistingPathsWithinRoot, B as BrowserTargetAmbiguousError, D as DEFAULT_DOWNLOAD_DIR, F as BrowserProfileNotFoundError, H as toBrowserErrorResponse, I as BrowserProfileUnavailableError, J as withBrowserNavigationPolicy, K as assertBrowserNavigationResultAllowed, L as BrowserResetUnsupportedError, M as resolveWritablePathWithinRoot, N as BrowserConfigurationError, O as DEFAULT_TRACE_DIR, P as BrowserConflictError, R as BrowserResourceExhaustedError, S as CDP_JSON_NEW_TIMEOUT_MS, U as InvalidBrowserNavigationUrlError, V as BrowserValidationError, W as assertBrowserNavigationAllowed, X as normalizeBrowserFormField, Z as isLoopbackHost, a as resolveOpenClawUserDataDir, b as ensureChromeExtensionRelayServer, c as resolveBrowserExecutableForPlatform, et as DEFAULT_AI_SNAPSHOT_MAX_CHARS, f as normalizeCdpWsUrl, g as fetchOk, h as fetchJson, i as launchOpenClawChrome, k as DEFAULT_UPLOAD_DIR, l as captureScreenshot, m as appendCdpPath, n as isChromeCdpReady, nt as DEFAULT_OPENCLAW_BROWSER_COLOR, o as stopOpenClawChrome, p as snapshotAria, q as requiresInspectableBrowserNavigationRedirects, r as isChromeReachable, rt as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as createTargetViaCdp, v as normalizeCdpHttpBaseForJsonEndpoints, w as resolveCdpReachabilityTimeouts, x as stopChromeExtensionRelayServer, z as BrowserTabNotFoundError } from "./chrome-Ct-HBrex.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-BC9BA6b0.js";
import { a as saveMediaBuffer, n as ensureMediaDir } from "./store-BfiJnRiX.js";
import { t as generateSecureToken } from "./secure-random-_kmh2emF.js";
import { i as resolveWindowsSpawnProgram, n as materializeWindowsSpawnProgram } from "./windows-spawn-CpTF7CWy.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-0g_EFT5q.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-0g_EFT5q.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
