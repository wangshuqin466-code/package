import { J as resolveAgentModelPrimaryValue, O as runExec, q as resolveAgentModelFallbackValues } from "./run-with-concurrency-DKyjYPBF.js";
import { y as normalizeChatType } from "./plugins-BB8tJCZU.js";
import { E as loadConfig, I as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, L as isInboundPathAllowed, R as mergeInboundPathRoots, ar as normalizeProviderId, fr as normalizeGoogleModelId, i as resolveApiKeyForProvider, qn as resolveOpenClawAgentDir, r as requireApiKey, z as resolveIMessageAttachmentRoots } from "./model-auth-BQbQxm_U.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, X as resolvePreferredOpenClawTmpDir } from "./logger-D-NoZ0-e.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-CyRyYsp0.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-C5phNNN6.js";
import { n as fetchWithTimeout } from "./fetch-timeout-UxR1blUr.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CatMHzad.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BDgsszn0.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-Dj0s_gDM.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-DWi0z2To.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-B6gBxu2i.js").then((n) => n.r);
