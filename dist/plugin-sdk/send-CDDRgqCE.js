import { D as normalizeMimeType, E as kindFromMime, S as getFileExtension, T as isGifMedia } from "./message-channel-BfBFtOb7.js";
import { I as danger, O as createSubsystemLogger, R as logVerbose, g as safeParseJson, t as CONFIG_DIR } from "./utils-B0IyLNx9.js";
import { c as resolveStateDir, d as resolveRequiredHomeDir, l as expandHomePrefix, o as resolveOAuthDir } from "./paths-Dmn791zP.js";
import { st as normalizeAccountId } from "./run-with-concurrency-C-4lcmuz.js";
import { c as resolveTelegramAccount, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-QUFoiGWF.js";
import { D as loadConfig, Ir as isTruthyEnvValue, M as writeConfigFile, Wn as withFileLock$1, jn as resolveTelegramPreviewStreamMode, k as readConfigFileSnapshotForWrite } from "./model-auth-D4ii__OS.js";
import { c as hasProxyEnvConfigured } from "./ssrf-Bs2JKULn.js";
import { r as writeJsonAtomic } from "./json-files-D5o1S-NW.js";
import { t as redactSensitiveText } from "./redact-CzWQJedj.js";
import { i as formatUncaughtError, n as extractErrorCode, o as readErrorName, r as formatErrorMessage, t as collectErrorGraphCandidates } from "./errors-BB_karnD.js";
import { t as makeProxyFetch } from "./proxy-fetch-BKb1uyZt.js";
import { n as normalizeTelegramLookupTarget, r as parseTelegramTarget, t as normalizeTelegramChatId } from "./targets-ByB5-FPs.js";
import { a as loadWebMedia, n as markdownToIR, s as resolveMarkdownTableMode, t as chunkMarkdownIR } from "./ir-DyOTDYR5.js";
import { t as renderMarkdownWithMarkers } from "./render-CzX4G4T8.js";
import { n as normalizePollInput } from "./polls-BBEjT4NO.js";
import { t as buildOutboundMediaLoadOptions } from "./load-options-Bdwr4pWG.js";
import { t as resolveFetch } from "./fetch-DGF0QEJn.js";
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-CWD5Jl5G.js";
...
//#endregion
export { getPairingAdapter as $, expandTextLinks as A, resolveTelegramStreamMode as B, buildSenderName as C, buildTelegramThreadParams as D, buildTelegramParentPeer as E, resolveTelegramDirectPeerId as F, resolveSenderAllowMatch as G, isSenderAllowed as H, resolveTelegramForumThreadId as I, readChannelAllowFromStore as J, isVoiceCompatibleAudio as K, resolveTelegramGroupAllowFromContext as L, getTelegramTextParts as M, hasBotMention as N, buildTypingThreadParams as O, normalizeForwardedContext as P, writeJsonFileAtomically as Q, resolveTelegramMediaPlaceholder as R, buildSenderLabel as S, buildTelegramGroupPeerId as T, normalizeAllowFrom as U, resolveTelegramThreadSpec as V, normalizeDmAllowFromWithStore as W, upsertChannelPairingRequest as X, removeChannelAllowFromStoreEntry as Y, readJsonFileWithFallback as Z, wrapFileReferencesInHtml as _, reactMessageTelegram as a, formatLocationText as at, withTelegramApiErrorLogging as b, sendStickerTelegram as c, resolveCronStorePath as d, listPairingChannels as et, wasSentByBot as f, renderTelegramHtmlText as g, markdownToTelegramHtml as h, editMessageTelegram as i, resolveGroupAllowFromSources as it, extractTelegramLocation as j, describeReplyTarget as k, resolveTelegramVoiceSend as l, markdownToTelegramChunks as m, createForumTopicTelegram as n, isSenderIdAllowed as nt, sendMessageTelegram as o, toLocationContext as ot, isRecoverableTelegramNetworkError as p, addChannelAllowFromStoreEntry as q, deleteMessageTelegram as r, mergeDmAllowFromSources as rt, sendPollTelegram as s, buildInlineKeyboard as t, firstDefined as tt, loadCronStore as u, resolveTelegramFetch as v, buildTelegramGroupFrom as w, buildGroupLabel as x, splitTelegramCaption as y, resolveTelegramReplyId as z };
