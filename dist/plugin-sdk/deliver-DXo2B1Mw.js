import { dt as normalizeOptionalAccountId, ut as normalizeAccountId } from "./run-with-concurrency-tODp1hy3.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-e62olPre.js";
import { Bt as getActivePluginRegistryVersion, Qt as triggerInternalHook, Rt as getActivePluginRegistry, Zt as createInternalHookEvent } from "./model-auth-BQ4Cp3j8.js";
import { O as createSubsystemLogger, R as logVerbose } from "./logger-D-NoZ0-e.js";
import { c as resolveStateDir } from "./paths-CyBu6eBm.js";
import { d as getChannelDock } from "./thinking-D-7Pwj4y.js";
import { Rt as parseInlineDirectives, i as isMessagingToolDuplicate, mt as resolveMirroredTranscriptText, pt as appendAssistantMessageToSessionTranscript } from "./pi-embedded-helpers-C7GCMUPD.js";
import { n as generateSecureUuid } from "./secure-random-CIAkYcNr.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-DR4GvGT2.js";
import { i as isSilentReplyText } from "./tokens-C6pUhnym.js";
import { r as parseTelegramTarget } from "./targets-C_5PIxsJ.js";
import { d as chunkMarkdownTextWithMode, h as resolveTextChunkLimit, l as chunkByParagraph, m as resolveChunkMode, s as resolveMarkdownTableMode, v as parseFenceSpans } from "./ir-BzuJwcEb.js";
import { c as markdownToSignalTextChunks, t as sendMessageSignal } from "./send-BxC7n_GZ.js";
