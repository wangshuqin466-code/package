import { I as resolvePathViaExistingAncestorSync, O as runExec, Q as buildAgentMainSessionKey, S as ensureAgentWorkspace, W as normalizeHyphenSlug, X as DEFAULT_AGENT_ID, _ as DEFAULT_HEARTBEAT_FILENAME, at as resolveAgentIdFromSessionKey, b as DEFAULT_TOOLS_FILENAME, dt as normalizeOptionalAccountId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, it as normalizeMainKey, j as openBoundaryFile, m as DEFAULT_AGENTS_FILENAME, rt as normalizeAgentId, v as DEFAULT_IDENTITY_FILENAME, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-tODp1hy3.js";
import { r as normalizeChannelId, x as normalizeChatType } from "./plugins-e62olPre.js";
import { $n as isPidAlive, Bn as containsEnvVarReference, D as loadConfig, Dr as hasConfiguredSecretInput, M as writeConfigFile, Qn as getProcessStartTime, Ur as parseBooleanValue, Wr as formatCliCommand, Zn as resolveProcessScopedMap, et as secretRefKey, jr as resolveSecretInputRef, jt as CHANNEL_IDS, nt as parseDurationMs, rt as parseByteSize, tt as getBlockedNetworkModeReason, v as resolveSecretRefValues, w as createConfigIO } from "./model-auth-BQ4Cp3j8.js";
...
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-D-7Pwj4y.js";
import { t as SsrFBlockedError } from "./ssrf-BOgvekn1.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-CPqtW_nx.js";
import { T as normalizeMessageChannel, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, w as listDeliverableMessageChannels } from "./image-ops-BrTKipfG.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-Cn4jOpOv.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-EfXQPW7F.js";
import { $ as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, A as resolveExistingPathsWithinRoot, B as BrowserTargetAmbiguousError, D as DEFAULT_DOWNLOAD_DIR, F as BrowserProfileNotFoundError, H as toBrowserErrorResponse, I as BrowserProfileUnavailableError, J as withBrowserNavigationPolicy, K as assertBrowserNavigationResultAllowed, L as BrowserResetUnsupportedError, M as resolveWritablePathWithinRoot, N as BrowserConfigurationError, O as DEFAULT_TRACE_DIR, P as BrowserConflictError, R as BrowserResourceExhaustedError, S as CDP_JSON_NEW_TIMEOUT_MS, U as InvalidBrowserNavigationUrlError, V as BrowserValidationError, W as assertBrowserNavigationAllowed, X as normalizeBrowserFormField, Z as isLoopbackHost, a as resolveOpenClawUserDataDir, b as ensureChromeExtensionRelayServer, c as resolveBrowserExecutableForPlatform, et as DEFAULT_AI_SNAPSHOT_MAX_CHARS, f as normalizeCdpWsUrl, g as fetchOk, h as fetchJson, i as launchOpenClawChrome, k as DEFAULT_UPLOAD_DIR, l as captureScreenshot, m as appendCdpPath, n as isChromeCdpReady, nt as DEFAULT_OPENCLAW_BROWSER_COLOR, o as stopOpenClawChrome, p as snapshotAria, q as requiresInspectableBrowserNavigationRedirects, r as isChromeReachable, rt as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as createTargetViaCdp, v as normalizeCdpHttpBaseForJsonEndpoints, w as resolveCdpReachabilityTimeouts, x as stopChromeExtensionRelayServer, z as BrowserTabNotFoundError } from "./chrome-D5Lr0QX7.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-B_DPlC7t.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-8uK4lP7_.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-CReGQ7X8.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-C5u6XrXo.js";
import { t as generateSecureToken } from "./secure-random-CIAkYcNr.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-D4wZtuQE.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-B2l1KmaR.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-pezbWG91.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-pezbWG91.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
