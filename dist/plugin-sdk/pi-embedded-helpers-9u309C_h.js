import { g as getImageMetadata, m as buildImageResizeSideGrid, o as listDeliverableMessageChannels, p as IMAGE_REDUCE_QUALITY_STEPS, s as normalizeMessageChannel, y as resizeToJpeg } from "./message-channel-BfBFtOb7.js";
import { M as defaultRuntime, O as createSubsystemLogger, S as truncateUtf16Safe, d as normalizeE164, h as resolveUserPath } from "./utils-B0IyLNx9.js";
import { a as resolveGatewayPort, d as resolveRequiredHomeDir, n as STATE_DIR } from "./paths-Dmn791zP.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-BzgB37_t.js";
import { N as resolvePathViaExistingAncestorSync, O as openBoundaryFile, S as ensureAgentWorkspace, W as normalizeHyphenSlug, Y as buildAgentMainSessionKey, _ as DEFAULT_HEARTBEAT_FILENAME, b as DEFAULT_TOOLS_FILENAME, ct as normalizeOptionalAccountId, et as normalizeAgentId, f as resolveSessionAgentId, g as DEFAULT_BOOTSTRAP_FILENAME, h as DEFAULT_AGENT_WORKSPACE_DIR, i as resolveAgentConfig, m as DEFAULT_AGENTS_FILENAME, nt as resolveAgentIdFromSessionKey, q as DEFAULT_AGENT_ID, tt as normalizeMainKey, v as DEFAULT_IDENTITY_FILENAME, vt as runExec, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./run-with-concurrency-C-4lcmuz.js";
import { r as normalizeChannelId, y as normalizeChatType } from "./plugins-QUFoiGWF.js";
import { D as loadConfig, Gn as resolveProcessScopedMap, J as secretRefKey, Kn as getProcessStartTime, Lr as parseBooleanValue, M as writeConfigFile, Pn as containsEnvVarReference, Rr as formatCliCommand, Tr as resolveSecretInputRef, Tt as CHANNEL_IDS, X as parseDurationMs, Y as getBlockedNetworkModeReason, Z as parseByteSize, qn as isPidAlive, v as resolveSecretRefValues, w as createConfigIO, xr as hasConfiguredSecretInput } from "./model-auth-D4ii__OS.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-CChP2naf.js";
import { t as SsrFBlockedError } from "./ssrf-Bs2JKULn.js";
import { i as writeTextAtomic, r as writeJsonAtomic } from "./json-files-D5o1S-NW.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-BDzhyD2C.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-CcZSZF4e.js";
import { $ as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, A as resolveExistingPathsWithinRoot, B as BrowserTargetAmbiguousError, D as DEFAULT_DOWNLOAD_DIR, F as BrowserProfileNotFoundError, H as toBrowserErrorResponse, I as BrowserProfileUnavailableError, J as withBrowserNavigationPolicy, K as assertBrowserNavigationResultAllowed, L as BrowserResetUnsupportedError, M as resolveWritablePathWithinRoot, N as BrowserConfigurationError, O as DEFAULT_TRACE_DIR, P as BrowserConflictError, R as BrowserResourceExhaustedError, S as CDP_JSON_NEW_TIMEOUT_MS, U as InvalidBrowserNavigationUrlError, V as BrowserValidationError, W as assertBrowserNavigationAllowed, X as normalizeBrowserFormField, Z as isLoopbackHost, a as resolveOpenClawUserDataDir, b as ensureChromeExtensionRelayServer, c as resolveBrowserExecutableForPlatform, et as DEFAULT_AI_SNAPSHOT_MAX_CHARS, f as normalizeCdpWsUrl, g as fetchOk, h as fetchJson, i as launchOpenClawChrome, k as DEFAULT_UPLOAD_DIR, l as captureScreenshot, m as appendCdpPath, n as isChromeCdpReady, nt as DEFAULT_OPENCLAW_BROWSER_COLOR, o as stopOpenClawChrome, p as snapshotAria, q as requiresInspectableBrowserNavigationRedirects, r as isChromeReachable, rt as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as createTargetViaCdp, v as normalizeCdpHttpBaseForJsonEndpoints, w as resolveCdpReachabilityTimeouts, x as stopChromeExtensionRelayServer, z as BrowserTabNotFoundError } from "./chrome-ZCHqE_BV.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-DKmC-Nbk.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-CU27GHwO.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-BB_karnD.js";
import { i as saveMediaBuffer, n as ensureMediaDir } from "./store-BJ9f1Rx9.js";
import { t as generateSecureToken } from "./secure-random-C80kxT9g.js";
import { n as resolveWindowsSpawnProgram, t as materializeWindowsSpawnProgram } from "./windows-spawn-DQWaC5lK.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BT8b6HJe.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-BT8b6HJe.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
