import { dt as normalizeOptionalAccountId, ut as normalizeAccountId } from "./run-with-concurrency-CvBOjUE3.js";
import { Ar as createInternalHookEvent, _r as getActivePluginRegistry, jr as triggerInternalHook, yr as getActivePluginRegistryVersion } from "./config-upduwSBz.js";
import { O as createSubsystemLogger, R as logVerbose } from "./logger-CyvuRp4f.js";
import { c as resolveStateDir } from "./paths-D6tDENa_.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-f1v1_i9D.js";
import { d as getChannelDock } from "./thinking-B4aBdZa6.js";
import { Rt as parseInlineDirectives, i as isMessagingToolDuplicate, mt as resolveMirroredTranscriptText, pt as appendAssistantMessageToSessionTranscript } from "./pi-embedded-helpers-C-tB5b5B.js";
import { i as isSilentReplyText } from "./tokens-DwHJ1omO.js";
import { n as generateSecureUuid } from "./secure-random-C48xAdD5.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-BxJbYi6l.js";
import { r as parseTelegramTarget } from "./targets-ByB5-FPs.js";
import { d as chunkMarkdownTextWithMode, h as resolveTextChunkLimit, l as chunkByParagraph, m as resolveChunkMode, s as resolveMarkdownTableMode, v as parseFenceSpans } from "./ir-DjYCWMG5.js";
import { c as markdownToSignalTextChunks, t as sendMessageSignal } from "./send-BfzX5ud_.js";
...
//#endregion
export { joinPresentTextSegments as A, normalizeChannelTargetInput as C, splitMediaFromOutput as D, parseReplyDirectives as E, getGlobalHookRunner as O, buildTargetResolverSignature as S, throwIfAborted as T, toInternalMessageReceivedContext as _, normalizeReplyPayloadsForDelivery as a, toPluginMessageReceivedEvent as b, filterMessagingToolDuplicates as c, shouldSuppressMessagingToolReplies as d, shouldSuppressReasoningPayload as f, toInternalMessagePreprocessedContext as g, deriveInboundMessageHookContext as h, normalizeOutboundPayloadsForJson as i, initializeGlobalHookRunner as k, filterMessagingToolMediaDuplicates as l, resolveReplyToMode as m, formatOutboundPayloadLog as n, applyReplyTagsToPayload as o, createReplyToModeFilterForChannel as p, normalizeOutboundPayloads as r, applyReplyThreading as s, deliverOutboundPayloads as t, isRenderablePayload as u, toInternalMessageTranscribedContext as v, normalizeTargetForProvider as w, fireAndForgetHook as x, toPluginMessageContext as y };
