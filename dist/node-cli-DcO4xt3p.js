import { D as colorize, f as defaultRuntime, k as theme } from "./subsystem-kzdGVyce.js";
import { d as resolveIsNixMode, g as resolveStateDir } from "./paths-BfR2LXbA.js";
import "./boolean-BHdNsbzF.js";
import { Cn as resolveInlineCommandMatch, H as loadConfig, _n as normalizeExecutableToken, bn as unwrapKnownShellMultiplexerInvocation, dn as POSIX_SHELL_WRAPPERS, en as analyzeArgvCommand, in as resolvePlannedSegmentArgv, ln as resolveCommandResolutionFromArgv, un as resolveExecutableFromPathEnv, xn as POSIX_INLINE_COMMAND_FLAGS, yn as unwrapKnownDispatchWrapperInvocation } from "./auth-profiles-UpqQjKB-.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { i as resolveAgentConfig } from "./agent-scope-BDXYqF89.js";
import "./utils-B4wShrgI.js";
import { a as sameFileIdentity } from "./boundary-file-read-CcBHg_z-.js";
import { i as logWarn } from "./logger-BWbD2ty6.js";
import "./exec-CDUUaRm4.js";
import "./github-copilot-token-CcBrBN3h.js";
import { a as sanitizeSystemRunEnvOverrides, i as sanitizeHostExecEnv } from "./host-env-security-blJbxyQo.js";
...
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext, t as withTimeout } from "./with-timeout-BbQnczA2.js";
...
import { i as resolveBrowserConfig } from "./server-context-Cysq8uwv.js";
...
import { r as writeJsonAtomic } from "./json-files-DX0_k14P.js";
import { n as evaluateShellAllowlist, r as resolveAllowAlwaysPatterns, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-CmGNghDQ.js";
import { n as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-BIU2HUmH.js";
import { hn as loadOrCreateDeviceIdentity, p as GatewayClient } from "./call-BfhGytph.js";
import "./pairing-token-Bu2Xt1ri.js";
import { _ as saveExecApprovals, c as normalizeExecApprovals, f as readExecApprovalsSnapshot, h as resolveExecApprovals, m as requiresExecApproval, n as addAllowlistEntry, o as mergeExecApprovalsSocketDefaults, p as recordAllowlistUse, r as ensureExecApprovals, v as requestJsonlSocket } from "./exec-approvals-Bc3G-ceB.js";
import { n as resolveSystemRunCommand, o as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-DKHL4lN5.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, l as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./arg-split--6QZMCyf.js";
import "./runtime-lifecycle-CI5BW-bB.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-wdU52rBJ.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-D5f-djeh.js";
import "./runtime-guard-qGANlyDE.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-D9VSfwQu.js";
import "./systemd-CKDkXL0B.js";
import "./service-CdVcSUMi.js";
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-GSkeESvN.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-DL7pm3Qo.js";
import { t as parsePort } from "./parse-port-BhmBKEXL.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-CqnIuiOP.js";
