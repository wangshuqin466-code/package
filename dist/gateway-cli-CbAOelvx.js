import { A as getChildLogger, C as setVerbose, D as colorize, M as getResolvedLoggerSettings, O as isRich, a as setConsoleSubsystemFilter, f as defaultRuntime, j as getLogger, k as theme, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger, x as logVerbose } from "./subsystem-kzdGVyce.js";
...
import { An as ensureControlUiAllowedOriginsForNonLoopbackBind, Ar as resolveDefaultModelForAgent, Dr as resolveAllowedModelRef, Fi as normalizeSecretInput, G as readConfigFileSnapshot, Gn as resolveSubagentMaxConcurrent, H as loadConfig, Ir as resolveThinkingDefault, K as readConfigFileSnapshotForWrite, L as migrateLegacyConfig, Nt as isAvatarHttpUrl, On as applyMergePatch, Pr as resolveSubagentConfiguredModelSelection, Pt as isAvatarImageDataUrl, Q as OpenClawSchema, Ri as DEFAULT_MODEL, Rt as looksLikeAvatarPath, U as parseConfigJson5, Un as buildTalkConfigResponse, W as readBestEffortConfig, Wn as resolveAgentMaxConcurrent, X as writeConfigFile, Z as validateConfigObjectWithPlugins, hr as buildAllowedModelSet, ht as parseByteSize, jr as resolveHooksGmailModel, jt as AVATAR_MAX_BYTES, kn as applyLegacyMigrations, kr as resolveConfiguredModelRef, mr as isPidAlive, mt as parseDurationMs, q as resolveConfigSnapshotHash, wr as normalizeModelSelection, xr as isCliProvider, yr as getModelRefStatus, z as createConfigIO, zi as DEFAULT_PROVIDER } from "./auth-profiles-UpqQjKB-.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { C as DEFAULT_MEMORY_FILENAME, D as ensureAgentWorkspace, E as DEFAULT_USER_FILENAME, M as resolveWorkspaceTemplateDir, S as DEFAULT_MEMORY_ALT_FILENAME, T as DEFAULT_TOOLS_FILENAME, _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, b as DEFAULT_HEARTBEAT_FILENAME, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, h as resolveSessionAgentId, i as resolveAgentConfig, j as resolveDefaultAgentWorkspaceDir, k as isWorkspaceOnboardingCompleted, l as resolveAgentModelFallbacksOverride, n as listAgentEntries, r as listAgentIds, u as resolveAgentSkillsFilter, w as DEFAULT_SOUL_FILENAME, x as DEFAULT_IDENTITY_FILENAME, y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-BDXYqF89.js";
...
import { E as isPlainObject, S as sleep, T as truncateUtf16Safe, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath } from "./utils-B4wShrgI.js";
...
import { i as logWarn, t as logDebug } from "./logger-BWbD2ty6.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-CDUUaRm4.js";
...
import { n as resolveRuntimeServiceVersion, t as VERSION } from "./version-Bxx5bg6l.js";
import { A as triggerInternalHook, D as clearInternalHooks, O as createInternalHookEvent, b as canonicalizePathVariant, h as createEmptyPluginRegistry, k as registerInternalHook, t as CHANNEL_IDS, u as getActivePluginRegistry, v as PROTECTED_PLUGIN_ROUTE_PREFIXES, y as canonicalizePathForSecurity } from "./registry-Gs6xb3DK.js";
import { d as isTestDefaultMemorySlotDisabled } from "./manifest-registry-CFnC0yb4.js";
import "./dock-6TSCZqEs.js";
import "./models-config-Ct5bZG7t.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-B2BIDASk.js";
import { $n as abortEmbeddedPiRun, Ar as resolveTtsProviderOrder, Br as getTotalQueueSize, C as resolveAgentDeliveryPlan, Cn as extractFileContentFromSource, Cr as getTtsProvider, Ct as normalizeOptionalSessionKey, D as createOutboundSendDeps$1, Dr as resolveTtsAutoMode, Dt as migrateLegacyCronPayload, E as createDefaultDeps, En as resolveInputFileLimits, Er as resolveTtsApiKey, Et as normalizeRequiredName, F as createReplyPrefixOptions, Fr as OPENAI_TTS_VOICES, Ft as closeTrackedBrowserTabsForSessions, G as createReplyDispatcher, Gr as CommandLane, Gt as parseVerboseOverride, Hr as resetAllLanes, I as buildHistoryContextFromEntries, In as countActiveDescendantRuns, It as applyBrowserProxyPaths, J as buildBareSessionResetPrompt, Jn as readLatestAssistantReply, Jr as stripHeartbeatToken, Jt as unbindThreadBindingsBySessionKey, K as getTotalPendingReplies, Kn as resolveAgentTimeoutMs, Kt as normalizeSpawnedRunMetadata, Lr as enqueueCommandInLane, Lt as persistBrowserProxyFiles, Mn as isAbortRequestText, Mr as setTtsProvider, Mt as detectSuspiciousPatterns, Nn as stopSubagentsForRequester, Nr as textToSpeech, Nt as getHookType, On as normalizeSendPolicy, Or as resolveTtsConfig, Ot as normalizeLegacyDeliveryInput, Pr as OPENAI_TTS_MODELS, Pt as isExternalHookSession, Q as createOpenClawTools, Qn as runEmbeddedPiAgent, Rr as getActiveTaskCount, Rt as resolveSessionAuthProfileOverride, Sn as DEFAULT_INPUT_TIMEOUT_MS, Sr as clearBootstrapSnapshotOnSessionRollover, St as normalizeOptionalAgentId, T as createOutboundSendDeps, Tn as normalizeMimeList, Tr as isTtsProviderConfigured, Tt as normalizePayloadToSystemText, Ur as setCommandLaneConcurrency, Ut as applyModelOverrideToSessionEntry, Vn as listDescendantRunsForRequester, Vr as markGatewayDraining, W as dispatchInboundMessage, Wr as waitForActiveTasks, Wt as applyVerboseOverride, X as setCliSessionId, Xn as clearSessionQueues, Y as getCliSessionId, Yt as normalizeGroupActivation, Z as runCliAgent, Zn as buildOutboundSessionContext, Zt as loadProviderUsageSummary, _ as requestBodyErrorToText, _t as writeRestartSentinel, a as getPluginToolMeta, ar as emitAgentEvent, at as resolveSessionDeliveryTarget, bn as DEFAULT_INPUT_IMAGE_MAX_BYTES, bt as normalizeCronJobPatch, c as loadOpenClawPlugins, cr as registerAgentRunContext, ct as resetDirectoryCache, dr as resolveBootstrapWarningSignaturesSeen, dt as consumeRestartSentinel, er as getActiveEmbeddedRunCount, et as ensureOutboundSessionEntry, ft as formatDoctorNonInteractiveHint, g as readJsonBodyWithLimit, h as handleSlackHttpRequest, hr as resolveAgentIdentity, ht as summarizeRestartSentinel, ir as clearAgentRunContext, it as resolveOutboundTarget, j as resolveAgentAvatar, jr as setTtsEnabled, jt as buildSafeExternalPrompt, kn as resolveSendPolicy, kr as resolveTtsPrefsPath, l as createPluginRuntime, ln as enqueueSystemEvent, mr as resolveAgentSessionDirs, n as applyToolPolicyPipeline, o as resolvePluginTools, or as getAgentRunContext, ot as resolveOutboundChannelPlugin, p as resolveAgentOutboundIdentity, pn as requestHeartbeatNow, pr as getAcpSessionManager, pt as formatRestartSentinelMessage, qn as resolveAnnounceTargetFromKey, qt as resolveIngressWorkspaceOverrideForSpawnedRun, r as buildDefaultToolPolicyPipelineSteps, rr as resolveCronStyleNow, sr as onAgentEvent, tn as formatZonedTimestamp, tr as waitForEmbeddedPiRunEnd, tt as resolveOutboundSessionRoute, un as isSystemEventContextChanged, ut as runWithModelFallback, vt as normalizeHttpWebhookUrl, w as resolveAgentOutboundTarget, wn as extractImageContentFromSource, wr as isTtsEnabled, wt as normalizeOptionalText, x as agentCommandFromIngress, xn as DEFAULT_INPUT_IMAGE_MIMES, xr as clearBootstrapSnapshot, xt as inferLegacyName, yr as resolveUserTimezone, yt as normalizeCronJobCreate, zn as initSubagentRegistry } from "./compact-D3emcZgv.js";
import { g as buildChannelAccountBindings, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-v0UiRqAc.js";
import { i as resolveWhatsAppAccount } from "./accounts-CFByy36g.js";
import { p as normalizeWhatsAppTarget } from "./channel-config-helpers-Cc37-fbu.js";
import "./send-CbPREZmS.js";
import "./send-Bj6Jq5a4.js";
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-BbQnczA2.js";
import { j as runGlobalGatewayStopSafely, k as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-bv9qu6sz.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, h as isDiagnosticsEnabled } from "./diagnostic-BjGEEiT0.js";
import "./accounts-Dd357WkV.js";
import { c as detectMime } from "./image-ops-BZX4S9OA.js";
import { b as resolveCronStorePath, x as saveCronStore, y as loadCronStore } from "./send-oxP8y9QI.js";
import "./pi-model-discovery-CHZFD2LJ.js";
import { _ as normalizeGatewayClientMode, f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-FOsBizRL.js";
import "./pi-embedded-helpers-nnm4iOi3.js";
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-D5S9pIUQ.js";
import { i as listCoreToolSections, n as PROFILE_OPTIONS, o as resolveCoreToolProfiles } from "./tool-catalog-DAnzECvM.js";
import "./chrome-_dzns-pF.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-DwUR_aBY.js";
import { t as safeEqualSecret } from "./secret-equal-BJ708tmX.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-BEiNr4qb.js";
import { c as normalizeHostHeader, d as resolveGatewayBindHost, f as resolveGatewayListenHosts, i as isLoopbackHost, l as pickPrimaryLanIPv4, n as isLocalishHost, o as isTrustedProxyAddress, r as isLoopbackAddress, s as isValidIPv4, t as rawDataToString, u as resolveClientIp } from "./ws-BzHIlqUk.js";
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-ztX1XT7i.js";
import { a as readGatewayPasswordEnv, o as readGatewayTokenEnv } from "./credentials-UUOBfSK0.js";
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-CALUVGLW.js";
import { d as mergeGatewayTailscaleConfig, l as ensureGatewayStartupAuth, u as mergeGatewayAuthConfig } from "./server-context-Cysq8uwv.js";
import { f as hasBinary } from "./frontmatter-B5Xx_5Cp.js";
import "./env-overrides-CghEbWu_.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-2B2VwR9Z.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-BcTP9HTD.js";
import "./paths-Bv0Fd5hm.js";
import { n as SsrFBlockedError } from "./proxy-env-DBXIh4R2.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-b9XS0Muh.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-oTqWODa8.js";
import { i as openFileWithinRoot, l as writeFileWithinRoot, s as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-DnLkCsXk.js";
import { n as cleanOldMedia } from "./store-Cpd6HHUc.js";
import { n as inspectPortUsage, o as formatPortDiagnostics, t as ensurePortAvailable } from "./ports-DwmubRiU.js";
import { t as movePathToTrash } from "./trash-CKkKoeyk.js";
...
import { $ as resolveAgentMainSessionKey, A as capArrayByJsonBytes, B as stripInlineDirectiveTagsFromMessageForDisplay, E as normalizeSessionDeliveryFields, F as resolveSessionTranscriptCandidates, G as resolveSessionResetPolicy, I as stripEnvelopeFromMessage, L as stripEnvelopeFromMessages, M as readSessionMessages, N as readSessionPreviewItemsFromTranscript, O as archiveFileOnDisk, Q as canonicalizeMainSessionAlias, S as deliveryContextFromSession, U as evaluateSessionFreshness, V as jsonUtf8Bytes, Y as mergeSessionEntry, Z as setSessionRuntimeModel, a as extractDeliveryInfo, c as loadSessionStore, et as resolveExplicitAgentSessionKey, it as snapshotSessionOrigin, j as cleanupArchivedSessionTranscripts, k as archiveSessionTranscripts, lt as cleanStaleLockFiles, m as updateSessionStore, nt as resolveMainSessionKeyFromConfig, o as parseSessionThreadInfo, s as archiveRemovedSessionTranscripts, tt as resolveMainSessionKey, w as mergeDeliveryContext, z as stripInlineDirectiveTagsForDisplay } from "./sessions-Bh025Q5O.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-D3cXuvcv.js";
import { i as normalizeInputProvenance } from "./input-provenance-g_SG213w.js";
import "./chat-envelope-Ba8wEdTK.js";
import { o as estimateBase64DecodedBytes } from "./tool-images-CpDLyo5v.js";
import { a as normalizeElevatedLevel, c as normalizeUsageDisplay, d as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeReasoningLevel, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-CHrWXrB4.js";
import "./exec-approvals-allowlist-CmGNghDQ.js";
import "./exec-safe-bin-runtime-policy-BIU2HUmH.js";
import { n as loadModelCatalog } from "./model-catalog-RhG2KE3w.js";
import "./fetch-CEXnYKAv.js";
import { v as registerUnhandledRejectionHandler } from "./audio-transcription-runner-CkHnvIGC.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-W2TcXMQH.js";
import { b as extractTextFromChatContent } from "./image-CiVJHtoW.js";
...
import { a as ToolInputError } from "./target-errors-DkGMVAsH.js";
import { r as isRestartEnabled } from "./commands-7gthnTya.js";
import "./commands-registry-Cw8jiBIe.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-0f4Id4RU.js";
...
import { n as GATEWAY_AUTH_SURFACE_PATHS, p as isKnownSecretTargetId, r as evaluateGatewayAuthSurfaceStates } from "./runtime-config-collectors-mVzg9wUg.js";
import "./command-secret-targets-tuZ5jpnm.js";
import "./connection-auth-wdU52rBJ.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-Be9c-Ktq.js";
import "./prompt-style-DMLxb9pN.js";
import "./pairing-labels-D1eHodye.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-C0jP3BCc.js";
import { i as resolveMemorySearchConfig } from "./manager-_AfSnopa.js";
...
import { n as withProgress } from "./progress-BVJ8qDnh.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BMEa9FVA.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-EVpfH2cW.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-D3MLADBR.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-DVxMo6EK.js";
import { t as readSecretFromFile } from "./secret-file-Djb3Ii-H.js";
import { n as inheritOptionFromParent } from "./command-options-BihXZRbG.js";
import { t as WizardCancelledError } from "./prompts-s5Kzq1GQ.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-BzTuVo-H.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-a9hEY-ei.js";
import { t as isWithinDir } from "./path-safety-D9zc0rNm.js";
import "./install-safe-path-DLZIuTKk.js";
import "./skill-scanner-CB0FoAsR.js";
import { n as formatConfigIssueLines } from "./issue-format-BnatXrUa.js";
import { t as buildChannelAccountSnapshot } from "./status-BnjN8DEq.js";
import "./channels-status-issues-CpfvpmtK.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-DQgqDneJ.js";
import "./daemon-install-plan.shared-D5f-djeh.js";
import "./runtime-guard-qGANlyDE.js";
import "./gateway-install-token-BGQWARl6.js";
import "./systemd-CKDkXL0B.js";
import "./service-CdVcSUMi.js";
import "./lifecycle-core-GSkeESvN.js";
import "./systemd-hints-DL7pm3Qo.js";
import { t as parsePort$1 } from "./parse-port-BhmBKEXL.js";
import { c as parseProcCmdline, n as addGatewayServiceCommands, s as isGatewayArgv } from "./daemon-cli-CaswyGKk.js";
import { r as probeGateway } from "./probe-auth-DgUws4V_.js";
import "./diagnostics-CAedsq6U.js";
import "./table-o9Qa9g3_.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-Bf_j7Pjv.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-D5X6EiII.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-CsYoZ6tt.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-B_hbs0r0.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as isCronSystemEvent } from "./health-DL8GZdZB.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DCpYiequ.js";
import { m as normalizeUpdateChannel, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-D8x6Enw3.js";
import { a as resolveCommandSecretsFromActiveRuntimeSnapshot, i as prepareSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-D7LGJX7r.js";
import "./onboarding.secret-input-DHqDidXH.js";
import { t as runOnboardingWizard } from "./onboarding-Biq7B2y0.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-CV629r4j.js";
import { _ as buildGogWatchStartArgs, g as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, w as resolveGmailHookRuntimeConfig } from "./gmail-setup-utils-mjQ8KkF7.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-ZUabeeGr.js";
import { n as collectEnabledInsecureOrDangerousFlags } from "./audit-DZk9E5an.js";
import "./node-service-CpXtzg7G.js";
import "./status.update-Ck36Zdaf.js";
import { t as installSkill } from "./skills-install-Bau58qL-.js";
import { t as runGatewayUpdate } from "./update-runner-CGkDyVpo.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-CRnWKAzq.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-CRpuvPaX.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DMLrpVX8.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-0f4Id4RU.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-7R9AGnAR.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-cVcGAG6r.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-bv9qu6sz.js").then((n) => n.n);
